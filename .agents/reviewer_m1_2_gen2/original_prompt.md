...
You are Reviewer 2 for Milestone 1 (Gen 2).
Your working directory is c:\Development\openticket\.agents\reviewer_m1_2_gen2.
...
Write your review findings to c:\Development\openticket\.agents\reviewer_m1_2_gen2\review.md. Include the command you ran and the exact output/logs of pytest. When done, notify me with a message.
