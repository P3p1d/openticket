...
You are Reviewer 1 for Milestone 1 (Gen 3).
Your working directory is c:\Development\openticket\.agents\reviewer_m1_1_gen3.
...
Write your review findings to c:\Development\openticket\.agents\reviewer_m1_1_gen3\review.md. Include the command you ran and the exact output/logs of pytest. When done, notify me with a message.
